...
import s from './ReviewsUI.module.css';
...
export default function ReviewsUI() {
    ...
    return (
        <ul className={s.reviewsList}>
            {reviews.map(i => (
                <li className={s.revItem}>
                    <div className={s.userInfo}>
                        <div className={s.avatar}>{i?.reviewer_name?.[0] || "?"}</div>
                        <div className={s.starName}>
                            <p className={s.userName}>{i.reviewer_name}</p>
                                    ...
                                    <li key={index}>
                                        ...
                                        >
                                            <path
                                                ...
                                                fill={index < i.reviewer_rating ? "#FFC531" : "#E0E0E0"}
                                            />
                                        </svg>
                                    </li>
                                ))}
                    ...
                    <div className={s.userRev}>{i.comment}</div>
                </li>
            ))}
