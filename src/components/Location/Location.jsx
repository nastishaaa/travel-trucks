        ...
        <div className={s.locationContainer}>
            ...
            <div className={s.placeholderWrapper}>
                <div className={s.placeholderContent}>
                    ...
                    <p className={s.locationP}>Kyiv, Ukraine</p>
                </div>
            </div>
        </div>
    );
